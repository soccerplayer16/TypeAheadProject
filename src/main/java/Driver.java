...
public class Driver {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException, InterruptedException {
		...
		* */
		// has to specify the time zone..... 
		DBConfiguration.configureDB(conf2, 
				"com.mysql.jdbc.Driver",
				"jdbc:mysql://192.168.0.31:8889/test?autoReconnect=true&useSSL=false&serverTimezone=UTC",
				"root",
				"root");
		...
		job2.addArchiveToClassPath(new Path("/mysql/mysql-connector-java-5.1.48-bin.jar"));
